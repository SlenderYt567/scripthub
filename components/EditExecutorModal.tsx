                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div className="space-y-1">
                                ...
                                <div className="relative group">
                                    ...
                                    <label htmlFor="edit-executor-image-upload" className={`h-[150px] w-full flex items-center justify-center border border-dashed rounded-lg cursor-pointer transition-all overflow-hidden relative ${imagePreview
                                        ...
                                        {imagePreview ? (
                                            ...
                                            <div className="flex flex-col items-center gap-2">
                                                ...
                                                <span className="text-sm font-bold">Change Cover Image</span>
                                            </div>
                                        )}
                                    </label>
                                </div>
