...
import { ArrowLeft, Play, Calendar, User, Eye, ShieldCheck, Gamepad2, AlertTriangle } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 flex flex-col">
          ...
          <div className="mt-auto pt-6 border-t border-slate-800">
            <button 
              onClick={onGetScript}
              className="w-full md:w-auto md:min-w-[250px] flex items-center justify-center gap-3 px-8 py-4 bg-indigo-600 hover:bg-indigo-500 text-white text-lg font-bold rounded-xl transition-all shadow-xl shadow-indigo-600/20 hover:scale-[1.02] active:scale-95"
            >
